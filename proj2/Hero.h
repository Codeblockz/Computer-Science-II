...
const string FREESTYLE = "freestyle"; //literal
const string BREAKIN = "breakin";//literal
const string SILLY =  "silly";//literal
const string WON ="You have DEFEATED your enemy. Nice moves!"; // win statement
const string LOSE = "You have LOST to your enemy!"; // Lose statement
const string TIE = "You have TIED"; // Tie statement
const string SUPPER = " have busted out some righteous  moves and you WON the battle!";// heroicDance statement
